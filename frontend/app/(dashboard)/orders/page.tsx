    ...
    return (
        <div className="space-y-6 animate-fade-in relative">
            ...
            {showAssignModal && assignmentDraft && (
                <div className="fixed inset-0 bg-black/20 backdrop-blur-md flex items-center justify-center z-[100] animate-fade-in p-4" onClick={closeAssignModal}>
            ...
            {showReqModal && reqModalStudent && (
                <div className="fixed inset-0 bg-black/20 backdrop-blur-md flex items-center justify-center z-[100] animate-fade-in p-4" onClick={() => setShowReqModal(false)}>
