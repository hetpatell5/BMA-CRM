...
export default function SettingsPage() {
    ...
    return (
        <div className="space-y-6" onClick={() => showAssignMenu !== null && setShowAssignMenu(null)}>
            ...
            {/* ─── ADD MEMBER MODAL ─── */}
            {showAddModal && (
                <div className="fixed inset-0 bg-background/80 backdrop-blur-sm flex items-center justify-center z-50 p-4 !mt-0">
            ...
            {showDeleteConfirm && deleteTarget && (
                <div className="fixed inset-0 bg-background/80 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-fade-in !mt-0">
