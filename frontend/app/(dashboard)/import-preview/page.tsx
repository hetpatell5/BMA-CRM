                        ...
                        <table className="w-full border-collapse text-sm">
                            <thead className="sticky top-0 z-10 shadow-sm">
                                <tr className="border-b border-border bg-slate-50 dark:bg-slate-800">
                                    ...
                                    <th className="p-2 text-left font-bold text-slate-500 dark:text-slate-200 border-r border-border whitespace-nowrap bg-indigo-50 dark:bg-indigo-900/30 sticky right-[100px] z-20 shadow-[-4px_0_8px_-2px_rgba(0,0,0,0.12)]">
                                        <span className="flex items-center gap-1.5">
                                    ...
                                    students.map((student: any) => {
                                        ...
                                        return (
                                            <tr key={id} className={cn('border-b border-border transition-colors group/row', isSelected ? 'bg-primary/5' : 'hover:bg-slate-50/50 dark:hover:bg-white/[0.02]')}>
                                                ...
                                                {/* IGNOU Status cell */}
                                                <td className="p-2 border-r border-border text-[13px] min-w-[130px] sticky right-[100px] z-10 bg-background group-hover/row:bg-slate-50 dark:group-hover/row:bg-slate-900/80 shadow-[-4px_0_8px_-2px_rgba(0,0,0,0.08)]">
                                                    {!ignouCheck ? (
                                                ...
                                                <td className="p-2 border-l border-border sticky right-0 z-20 bg-background group-hover/row:bg-slate-50 dark:group-hover/row:bg-slate-900/80 w-[100px] min-w-[100px]" onClick={e => e.stopPropagation()}>
                                                    <Button
